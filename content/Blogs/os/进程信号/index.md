...
<img src="./.进程信号.IMG/image-20230328145202289.png" alt="image-20230328145202289" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/image-20230328162511749.png" alt="image-20230328162511749" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/image-20230328165546004.png" alt="image-20230328165546004" style="zoom:37%;" />

在云服务器中，core.id 是默认不会生成的，原因是云服务器的生产环境的核心转储是关闭的：

<img src="./.进程信号.IMG/image-20230328170100969.png" alt="image-20230328170100969" style="zoom:37%;" />

通过指令 ulimit -c size 设置 core 文件的大小：
<img src="./.进程信号.IMG/image-20230328170149299.png" alt="image-20230328170149299" style="zoom:37%;" />

如果再次用 Ctrl + \ 终止进程，可以看到提示语句：

<img src="./.进程信号.IMG/image-20230328170254384.png" alt="image-20230328170254384" style="zoom:37%;" />

在可执行程序的目录中还能看到 core 文件：
<img src="./.进程信号.IMG/image-20230328170334006.png" alt="image-20230328170334006" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/image-20230328182253226.png" alt="image-20230328182253226" style="zoom:37%;" />
...
`code-FILE + core.id`<img src="./.进程信号.IMG/image-20230328183219167.png" alt="image-20230328183219167" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/image-20230328185321771.png" alt="image-20230328185321771" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/image-20230329145031031.png" alt="image-20230329145031031" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/image-20230329151052743.png" alt="image-20230329151052743" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/image-20230328153804487.png" alt="image-20230328153804487" style="zoom:37%;" />

这个现象说明进程 signal 接口成功捕获了 2 号信号，并且验证了键盘组合键 Ctrl + C 就是 2 号信号。要杀死进程，只能使用`kill -9 pid`终止进程了。

<img src="./.进程信号.IMG/image-20230328154223280.png" alt="image-20230328154223280" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/image-20230329165340866.png" alt="image-20230329165340866" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/image-20230329170923741.png" alt="image-20230329170923741" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/image-20230329173336132.png" alt="image-20230329173336132" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/image-20230330152351149.png" alt="image-20230330152351149" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/image-20230330165759036.png" alt="image-20230330165759036" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/image-20230330170939779.png" alt="image-20230330170939779" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/image-20230330231109451.png" alt="image-20230330231109451" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/image-20230330233343954.png" alt="image-20230330233343954" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/image-20230331161543944.png" alt="image-20230331161543944" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/屏幕录制2023-03-31 23.13.00.gif" alt="屏幕录制 2023-03-31 23.13.00" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/屏幕录制2023-04-01 00.00.48.gif" alt="屏幕录制 2023-04-01 00.00.48" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/屏幕录制2023-04-01 00.41.57.gif" alt="屏幕录制 2023-04-01 00.41.57" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/image-20230401011326247.png" alt="image-20230401011326247" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/image-20230401011538755.png" alt="image-20230401011538755" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/image-20230401152200004.png" alt="image-20230401152200004" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/image-20230401194508662.png" alt="image-20230401194508662" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/image-20230401201210764.png" alt="image-20230401201210764" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBAMjAyMWRyYWdvbg==,size_20,color_FFFFFF,t_70,g_se,x_16.png" alt="在这里插入图片描述" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/image-20230401225659607.png" alt="image-20230401225659607" style="zoom:37%;" />

如果将代码中的 signal 去掉注释，捕捉 2 号信号，默认处理动作会发生变化：

<img src="./.进程信号.IMG/image-20230401230124731.png" alt="image-20230401230124731" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/屏幕录制2023-04-02 01.25.04.gif" alt="屏幕录制 2023-04-02 01.25.04" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/屏幕录制2023-04-02 15.12.01.gif" alt="屏幕录制 2023-04-02 15.12.01" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/image-20230402155358258.png" alt="image-20230402155358258" style="zoom:37%;" />

在 main 函数中调用了 insert 函数插入新结点 node2，而某个自定义的信号处理函数中也插入了新结点 node3 。插入的步骤分为两步：

<img src="./.进程信号.IMG/image-20230402155531283.png" alt="image-20230402155531283" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/image-20230402162318457.png" alt="image-20230402162318457" style="zoom:37%;" />

当 CPU 处于内核态执行完自定义信号捕捉函数 handler 中的 insert 的两个步骤后，整个链表的状态是这样的。CPU 切换回用户态后，继续执行 main 函数的 insert 操作剩下的第二步：头插后更新头结点。

<img src="./.进程信号.IMG/image-20230402162424955.png" alt="image-20230402162424955" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/image-20230402170316608.png" alt="image-20230402170316608" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/image-20230402173000393.png" alt="image-20230402173000393" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/屏幕录制2023-04-02 18.07.30.gif" alt="屏幕录制 2023-04-02 18.07.30" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/屏幕录制2023-04-02 18.53.08.gif" alt="屏幕录制 2023-04-02 18.53.08" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/image-20230402190623192.png" alt="image-20230402190623192" style="zoom:37%;" />
...
<img src="./.进程信号.IMG/image-20230402191140157.png" alt="image-20230402191140157" style="zoom:37%;" />
